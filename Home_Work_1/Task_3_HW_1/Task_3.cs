...
namespace Task_3
{// Програма написана не об'єктно-зорієнтовано!!!
   //Алгоритмічно - теж не добре. Ви не перебігаєте всю множину променів (без діагональних), 
    //а кірім того, якщо дірка є на верхньому дискретному шарі, та відповідно на протилежному кінці, це ще не означає що вона наскрізна....
